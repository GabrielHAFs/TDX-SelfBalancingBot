...
# This is our mocked loop, just to use the send_control_instruction function each 7 seconds
async def send_command():
    while True:
        await asyncio.sleep(7)
        await send_control_instructions() 

#This is the function that you should call in your code to asynchronous send commands to the Robot
